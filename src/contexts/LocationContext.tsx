...
export function LocationProvider({ children }: LocationProviderProps) {
    ...
    const loadLocation = async () => {
        try {
            const savedLocation = await Storage.getItem<Location>(StorageKeys.Location);
    ...
    const setLocation = async (newLocation: Location) => {
        try {
            ...
            await Storage.setItem(StorageKeys.Location, locationWithTimestamp);
    ...
    const clearLocation = async () => {
        try {
            await Storage.deleteItem(StorageKeys.Location);
